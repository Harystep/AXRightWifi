...
- (void)setBackStyle:(UINavBackButtonColorStyle)backStyle {
    if (backStyle) {
        [self.backBtn setImage:kIMAGE(@"nav_white_icon") forState:UIControlStateNormal];
        self.titleL.textColor = UIColor.whiteColor;
    } else {
        [self.backBtn setImage:kIMAGE(@"nav_back_icon") forState:UIControlStateNormal];
...
- (UIView *)naviView {
    if (!_naviView) {
        ...
        [self.backBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.leading.mas_equalTo(_naviView.mas_leading);
...
- (UIButton *)backBtn {
    if (!_backBtn) {
        ...
        [_backBtn setImage:kIMAGE(@"nav_back_icon") forState:UIControlStateNormal];
