...
+ (UIImage *)imageByApplyingAlpha:(CGFloat )alpha image:(UIImage*)image
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(image.size.width/2.0, image.size.height/2.0), NO, 0.0f);
    
    CGContextRef ctx = UIGraphicsGetCurrentContext();
    
    CGRect area = CGRectMake(0, 0, image.size.width/2.0, image.size.height/2.0);
