...
@interface AXChangeFlowDeviceCell ()
...
@implementation AXChangeFlowDeviceCell
...
+ (instancetype)changeFlowCardCellWithTableView:(UITableView *)tableView indexPath:(NSIndexPath *)indexPath {
    AXChangeFlowDeviceCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AXChangeFlowDeviceCell" forIndexPath:indexPath];
